...
<body>
						...
						<div class="list-group">
							<c:forEach items="${nameMap}" var="entry">
								<a id="list-group-item-${entry.key}"
									href="/StudentSys_fw2/main/mainAction.action?clsId=${entry.key}"
	...
	<!--学生删除表单-->
	<form id="frm_std_del" action="StudOptServlet" method="post" style="display:none">
	<input id="sid" name="studId" type="hidden">
	<input id="clsId" name="claszId" type="hidden" value="${cls.id}">
	</form>
						...
						<div class="form-group">
							...
							<div id="sex-text">
								<label class="radio-inline"> <input id="ssex_m"
									name="ssex" type="radio" id="ssex" value="1" checked> 男
								</label> <label class="radio-inline"> <input id="ssex_w"
									name="ssex" type="radio" id="ssex" value="0"> 女
								</label>
							</div>
							<input id="clsId" name="claszId" type="hidden" value="${cls.id}">
						</div>

...
<link rel="stylesheet" href="/StudentSys_fw/assets/css/bootstrap.min.css" />
<link rel="stylesheet"
	href="assets/font-awesome/4.2.0/css/font-awesome.min.css" />
<link rel="stylesheet" href="/StudentSys_fw/assets/css/bootstrapValidator.css" />

<!-- text fonts -->
<link rel="stylesheet" href="/StudentSys_fw/assets/fonts/fonts.googleapis.com.css" />

<!-- ace styles -->
<link rel="stylesheet" href="/StudentSys_fw/assets/css/ace.min.css" />

<!--[if lte IE 9]>
			<link rel="stylesheet" href="/StudentSys_fw/assets/css/ace-part2.min.css" />
		<![endif]-->
<link rel="stylesheet" href="/StudentSys_fw/assets/css/ace-rtl.min.css" />



<!--[if lte IE 9]>
		  <link rel="stylesheet" href="/StudentSys_fw/assets/css/ace-ie.min.css" />
		<![endif]-->

<!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->

<!--[if lt IE 9]>
		<script src="/StudentSys_fw/assets/js/html5shiv.min.js"></script>
		<script src="/StudentSys_fw/assets/js/respond.min.js"></script>
		<![endif]-->
</head>
...
<body class="login-layout">
							...
							<div id="login-box"
								...
								<div class="widget-body">
									<div class="widget-main">
										...
										<form id="login" method="post" action="/StudentSys_fw/login/loginAction.action">
											<fieldset>
								...
								<div class="widget-body">
									<div class="widget-main">
										...
										<form id="regiester" method="post"
											        action="/StudentSys_fw/login/registerAction.action">
											<fieldset>
												<div class="form-group">
													<label class="block clearfix"> <span
														class="block input-icon input-icon-right"> <input
	...
	<!--[if !IE]> -->
	<script src="/StudentSys_fw/assets/js/jquery.2.1.1.min.js"></script>

	<!-- <![endif]-->

	<!--[if IE]>
<script src="/StudentSys_fw/assets/js/jquery.1.11.1.min.js"></script>
<![endif]-->

	<!--[if !IE]> -->
	<script type="text/javascript">
		window.jQuery
				|| document.write("<script src='/StudentSys_fw/assets/js/jquery.min.js'>"
						+ "<"+"/script>");
	</script>
	...
	<!--[if IE]>
<script type="text/javascript">
 window.jQuery || document.write("<script src='/StudentSys_fw/assets/js/jquery1x.min.js'>"+"<"+"/script>");
</script>
<![endif]-->
	...
	<script type="text/javascript">
		if ('ontouchstart' in document.documentElement)
			document
					.write("<script src='/StudentSys_fw/assets/js/jquery.mobile.custom.min.js'>"
							+ "<"+"/script>");
	</script>
